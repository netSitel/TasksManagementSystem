...
namespace TasksManagementSystem.Models
{
    ...
    public partial class SelectAllActiveRecByEmertimiAndSup_Entitet_info_Result
    {
        ...
        public string element_id_gen { get; set; }
        public Nullable<int> tip_info_id { get; set; }
        public string tip_info_id_gen { get; set; }
