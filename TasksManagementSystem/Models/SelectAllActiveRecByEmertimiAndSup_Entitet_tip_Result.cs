...
namespace TasksManagementSystem.Models
{
    ...
    public partial class SelectAllActiveRecByEmertimiAndSup_Entitet_tip_Result
    {
        ...
        public Nullable<bool> elcat { get; set; }
        public string kodi { get; set; }
        public Nullable<int> kodifillim { get; set; }
        public Nullable<int> kodimbarim { get; set; }
        public Nullable<int> kodiaktual { get; set; }
        public string emertimi { get; set; }
        public string pershkrimi { get; set; }
        public string emertimiang { get; set; }
        public string pershkrimiang { get; set; }
        public Nullable<double> rradha { get; set; }
