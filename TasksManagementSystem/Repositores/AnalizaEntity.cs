...
namespace TasksManagementSystem.Repositores
{
    public class AnalizaEntity :IBaseEntity
    {
        ...
        int IBaseEntity.InsertEntity_access(string id_gen, int? id_sup, string id_sup_gen, int? id_ndr, string id_ndr_gen, int? analize_id, string analize_id_gen, int? perdoruesi_id, string perdoruesi_id_gen, bool? aktiv, DateTime? data_krijimit, int? perdorues_id, string perdorues_id_gen)
        {
            using (var context = new tasketEntities1())
            {
        ...
        int IBaseEntity.UpdateEntity_access(int? analize_id, int? perdoruesi_id)
        {
            using (var context = new tasketEntities1())
            {
