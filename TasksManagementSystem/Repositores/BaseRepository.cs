...
namespace TasksManagementSystem.Repositores
{
    public class BaseRepository : IBaseRepository
    {
        ...
        {
            return new taskDb().SelectA(tabela);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimiAndSup_Entitet(tabela, id_sup,emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimiAndSup_Entitet_access(tabela, id_sup,emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimiAndSup_Entitet_info(tabela, id_sup,emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimiAndSup_Entitet_kategori(tabela, id_sup,emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimiAndSup_Entitet_tip(tabela, id_sup,emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimiAndSup_Entitet_tip_info(tabela, id_sup,emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimiAndSup_Entitet_tip_info_ch(tabela, id_sup,emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimiAndSup_nder_Entitet_kategori(tabela, id_sup,emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimiAndSup_nder_Entitet_tip_kategori(tabela, id_sup,emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimi_Entitet(tabela, emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimi_Entitet_access(tabela, emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimi_Entitet_info(tabela, emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimi_Entitet_kategori(tabela, emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimi_Entitet_tip(tabela, emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimi_Entitet_tip_info(tabela, emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimi_Entitet_tip_info_ch(tabela, emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimi_nder_Entitet_kategori(tabela, emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByEmertimi_nder_Entitet_tip_kategori(tabela, emertimi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByKodiAndSup_Entitet(tabela, kodi,id_sup);
        }

        public ObjectResult<SelectAllActiveRecByKodi_Entitet_Result> SelectAllActiveRecByKodi_Entitet(string tabela, string kodi)
        {
            return new taskDb().SelectAllActiveRecByKodi_Entitet(tabela, kodi);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByNrrendor_Entitet(tabela, nrrendor);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByNrrendor_Entitet_access(tabela, nrrendor);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByNrrendor_Entitet_info(tabela, nrrendor);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByNrrendor_Entitet_kategori(tabela, nrrendor);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByNrrendor_Entitet_tip(tabela, nrrendor);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByNrrendor_Entitet_tip_info(tabela, nrrendor);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByNrrendor_Entitet_tip_info_ch(tabela, nrrendor);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByNrrendor_nder_Entitet_kategori(tabela, nrrendor);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByNrrendor_nder_Entitet_tip_kategori(tabela, nrrendor);
        }

        public ObjectResult<SelectAllActiveRecBySup_Entitet_Result> SelectAllActiveRecBySup_Entitet(string tabela, string id_sup)
        {
            return new taskDb().SelectAllActiveRecBySup_Entitet(tabela, id_sup);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecBySup_Entitet_access(tabela, id_sup);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecBySup_Entitet_info(tabela, id_sup);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecBySup_Entitet_kategori(tabela, id_sup);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecBySup_Entitet_tip(tabela, id_sup);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecBySup_Entitet_tip_info(tabela, id_sup);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecBySup_Entitet_tip_info_ch(tabela, id_sup);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecBySup_nder_Entitet_kategori(tabela, id_sup);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecBySup_nder_Entitet_tip_kategori(tabela, id_sup);
        }
        ...
        {
            return new taskDb().SelectAllActiveRecByTipId_Entitet(tabela, tip_id);
        }
        ...
        {
            return new taskDb().SelectAllActiveRec_nder_Entitet_kategori(tabela);
        }
        ...
        {
            return new taskDb().SelectAllActiveRec_nder_Entitet_tip_kategori(tabela);
        }
    }
}